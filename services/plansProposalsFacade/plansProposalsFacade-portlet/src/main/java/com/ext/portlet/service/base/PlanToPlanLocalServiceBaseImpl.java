...
/**
 * The base implementation of the plan to plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanToPlanLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PlanToPlanLocalServiceBaseImpl
    implements PlanToPlanLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanToPlanLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanToPlanLocalServiceUtil} to access the plan to plan local service.
     */
     ...
     */
    public PlanToPlan addPlanToPlan(PlanToPlan planToPlan)
        throws SystemException {
        planToPlan.setNew(true);

        planToPlan = planToPlanPersistence.update(planToPlan, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planToPlan);
     ...
     */
    public PlanToPlan createPlanToPlan(PlanToPlanPK planToPlanPK) {
        return planToPlanPersistence.create(planToPlanPK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deletePlanToPlan(PlanToPlanPK planToPlanPK)
        throws PortalException, SystemException {
        PlanToPlan planToPlan = planToPlanPersistence.remove(planToPlanPK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(planToPlan);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deletePlanToPlan(PlanToPlan planToPlan)
        throws SystemException {
        planToPlanPersistence.remove(planToPlan);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planToPlanPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return planToPlanPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return planToPlanPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public PlanToPlan fetchPlanToPlan(PlanToPlanPK planToPlanPK)
        throws SystemException {
        return planToPlanPersistence.fetchByPrimaryKey(planToPlanPK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public PlanToPlan getPlanToPlan(PlanToPlanPK planToPlanPK)
        throws PortalException, SystemException {
        return planToPlanPersistence.findByPrimaryKey(planToPlanPK);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planToPlanPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<PlanToPlan> getPlanToPlans(int start, int end)
        throws SystemException {
        return planToPlanPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getPlanToPlansCount() throws SystemException {
        return planToPlanPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public PlanToPlan updatePlanToPlan(PlanToPlan planToPlan)
        throws SystemException {
        return updatePlanToPlan(planToPlan, true);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public PlanToPlan updatePlanToPlan(PlanToPlan planToPlan, boolean merge)
        throws SystemException {
        planToPlan.setNew(false);

        planToPlan = planToPlanPersistence.update(planToPlan, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanToPlan",
            planToPlanLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.PlanToPlan");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planToPlanPersistence.getDataSource();
