...
public class PlanSectionModelImpl extends BaseModelImpl<PlanSection>
    ...
    public static final String TABLE_SQL_CREATE = "create table xcolab_PlanSection (id_ LONG not null primary key,planSectionDefinitionId LONG,planId LONG,content TEXT null,referencedId LONG,created DATE null,version LONG,planVersion LONG,updateAuthorId LONG)";
    ...
    public Object clone() {
        ...
        planSectionImpl.setReferencedId(getReferencedId());
    ...
    public CacheModel<PlanSection> toCacheModel() {
        ...
        planSectionCacheModel.referencedId = getReferencedId();
